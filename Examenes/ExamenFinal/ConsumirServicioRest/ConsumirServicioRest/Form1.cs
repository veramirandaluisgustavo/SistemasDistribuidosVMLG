...
namespace ConsumirServicioRest
{
    public partial class Form1 : Form
    {
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            string apiUrl = this.url + "clima/" + boxId.Text;
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            ...
            string jsonRequest = "{\"fecha\": \"" + PostFecha.Text + "\",\"temperatura\":\"" + PostTemperatura.Text + "\",\"id\":" + PostId.Text +"}";
        ...
        {
            // URL del servicio REST que deseas consumir
            string apiUrl = this.url + "clima/" + boxDelete.Text;

            // Datos de autenticación en formato JSON
            string jsonRequest = "{\"id\": \"" + PostId.Text + "\", \"fecha\": \"" + PostFecha.Text + "\",\"temperatura\":\"" + PostTemperatura.Text + "\"}";
            Console.WriteLine(jsonRequest);
        ...
        {
            // URL del servicio REST que deseas consumir
            string apiUrl = this.url + "clima/" + PutId.Text;

            // Datos de autenticación en formato JSON
            string jsonRequest = "{\"fecha\": \"" + PutFecha.Text + "\",\"temperatura\":\"" + PutTemperatura.Text + "\",\"id\":" + PutId.Text + "}";
            Console.WriteLine(jsonRequest);
